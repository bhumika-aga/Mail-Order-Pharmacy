...
<body>
	...
	<nav class="navbar navbar-inverse ">
		...
		<div class="" id="navbarText">
			<ul class="navbar-nav mr-auto text-center">
				<!-- <li class="nav-item"> -->
				<a class="nav-link" href="loginpage" id="loginBtn">Login</a>
				<!-- </li> -->
			</ul>
		</div>
	</nav>
	...
	<div id="loginModal" class="modal">
		...
		<form class="modal-content animate" name="loginform" model="UserData"
			...
			<span onclick="document.getElementById('loginModal')"
			...
			<div class="container">
				...
				<button type="submit" id="loginSubmit" style="">Login</button>
