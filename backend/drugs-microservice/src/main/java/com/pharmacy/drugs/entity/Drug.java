...
public class Drug {
    ...
    public Double getCostPerPackage() { return costPerPackage; }
    public void setCostPerPackage(Double costPerPackage) { this.costPerPackage = costPerPackage; }
    
    public String getMedicalComposition() { return medicalComposition; }
    public void setMedicalComposition(String medicalComposition) { this.medicalComposition = medicalComposition; }
}