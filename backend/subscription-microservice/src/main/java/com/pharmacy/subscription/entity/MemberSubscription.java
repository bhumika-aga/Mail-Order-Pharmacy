...
public class MemberSubscription {
    ...
    public RefillFrequency getRefillFrequency() {
        return refillFrequency;
    }
    
    public void setRefillFrequency(RefillFrequency refillFrequency) {
        this.refillFrequency = refillFrequency;
    }
    ...
    public MemberPrescription getPrescription() {
        return prescription;
    }
    
    public void setPrescription(MemberPrescription prescription) {
