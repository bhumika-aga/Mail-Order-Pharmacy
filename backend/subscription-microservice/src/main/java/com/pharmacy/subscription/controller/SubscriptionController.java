...
public class SubscriptionController {
    ...
    @Operation(summary = "Create new subscription", 
              description = "Create a new mail-order pharmacy subscription")
    ...
    public ResponseEntity<?> unsubscribe(
            @Parameter(description = "Subscription ID to cancel", required = true)
    ...
    @Operation(summary = "Get member subscriptions", 
    ...
    @Operation(summary = "Get active subscriptions", 
              description = "Get all active subscriptions for the authenticated member")
    ...
    @Operation(summary = "Get member prescriptions", 
              description = "Get all prescriptions for the authenticated member")
