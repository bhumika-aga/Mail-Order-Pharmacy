...
public class SubscriptionRequest {
    ...
    public String getDosagePerDay() { return dosagePerDay; }
    public void setDosagePerDay(String dosagePerDay) { this.dosagePerDay = dosagePerDay; }
    
    public Integer getPrescriptionCourse() { return prescriptionCourse; }
    public void setPrescriptionCourse(Integer prescriptionCourse) { this.prescriptionCourse = prescriptionCourse; }
    
    public String getDoctorDetails() { return doctorDetails; }
    public void setDoctorDetails(String doctorDetails) { this.doctorDetails = doctorDetails; }
    
    public MemberSubscription.RefillFrequency getRefillFrequency() { return refillFrequency; }
    public void setRefillFrequency(MemberSubscription.RefillFrequency refillFrequency) { this.refillFrequency = refillFrequency; }
