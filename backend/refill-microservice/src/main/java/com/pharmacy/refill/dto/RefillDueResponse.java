...
public class RefillDueResponse {
    ...
    public String getRefillFrequency() { return refillFrequency; }
    public void setRefillFrequency(String refillFrequency) { this.refillFrequency = refillFrequency; }
    
    public List<RefillDuePrescription> getPrescriptions() { return prescriptions; }
    public void setPrescriptions(List<RefillDuePrescription> prescriptions) { this.prescriptions = prescriptions; }
}