...
public class RefillStatusResponse {
    ...
    // Getters and Setters
    public String getRefillOrderId() { return refillOrderId; }
    public void setRefillOrderId(String refillOrderId) { this.refillOrderId = refillOrderId; }
    ...
    public RefillOrder.OrderStatus getOrderStatus() { return orderStatus; }
    public void setOrderStatus(RefillOrder.OrderStatus orderStatus) { this.orderStatus = orderStatus; }
    
    public RefillOrder.OrderType getOrderType() { return orderType; }
    public void setOrderType(RefillOrder.OrderType orderType) { this.orderType = orderType; }
    ...
    public List<RefillLineItemResponse> getLineItems() { return lineItems; }
    public void setLineItems(List<RefillLineItemResponse> lineItems) { this.lineItems = lineItems; }
