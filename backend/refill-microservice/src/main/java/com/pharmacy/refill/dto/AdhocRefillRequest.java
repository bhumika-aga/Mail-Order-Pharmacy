...
public class AdhocRefillRequest {
    ...
    public List<AdhocRefillPrescriptionRequest> getPrescriptions() { return prescriptions; }
    public void setPrescriptions(List<AdhocRefillPrescriptionRequest> prescriptions) { this.prescriptions = prescriptions; }
}