        ...
        {Array.isArray(subscriptions) && subscriptions.length > 0 ? (
          ...
          <Grid item xs={12}>
            <Typography
              ...
              textAlign="center"
            >
              No subscriptions found. Create your first subscription to get
              started.
            </Typography>
          </Grid>
        )}
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  setSubscriptionForm({
                    ...subscriptionForm,
                    prescriptionCourse: parseInt(e.target.value),
                  })
                }
              />
            </Grid>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setSubscriptionForm({
                      ...subscriptionForm,
                      refillFrequency: e.target.value as "WEEKLY" | "MONTHLY",
                    })
                  }
                >
          ...
          {selectedSubscription && (
            <Box sx={{ mt: 2 }}>
              ...
              <Typography>
                ...
                {selectedSubscription.refillFrequency}
              </Typography>
              <Typography>
                <strong>Location:</strong> {selectedSubscription.memberLocation}
              </Typography>
              <Typography>
                <strong>Date:</strong>{" "}
                {new Date(
              ...
              {selectedSubscription.prescription && (
                <Box mt={2}>
                  ...
                  <Typography>
                    ...
                    {selectedSubscription.prescription.drugId}
                  </Typography>
                  <Typography>
                    <strong>Dosage:</strong>{" "}
                    {selectedSubscription.prescription.dosagePerDay}
                  </Typography>
                  <Typography>
                    <strong>Course:</strong>{" "}
                    {selectedSubscription.prescription.prescriptionCourse} days
                  </Typography>
                  <Typography>
                    <strong>Doctor:</strong>{" "}
                    {selectedSubscription.prescription.doctorDetails}
                  </Typography>
                </Box>
              )}
            </Box>
