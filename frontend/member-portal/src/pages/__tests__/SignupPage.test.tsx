...
describe('SignupPage Component', () => {
  ...
  it('should check username availability on blur', async () => {
    ...
    await waitFor(() => {
      expect(mockedApiService.authService.checkUsernameAvailability).toHaveBeenCalledWith('testuser');
    });
  });
  ...
  it('should check email availability and show "Email is valid" message', async () => {
    ...
    await waitFor(() => {
      expect(mockedApiService.authService.checkEmailAvailability).toHaveBeenCalledWith('test@example.com');
    });
  ...
  it('should show error message on registration failure', async () => {
    mockedApiService.authService.register.mockRejectedValue(new Error('Registration failed'));
